...
// add vertical lines
NewPad();
draw(RootGetObject("../example.root", "hist"), "vl", blue);

// add error bars
NewPad();
draw(RootGetObject("../example.root", "hist"), "vl,eb", blue);

// add error bars
NewPad();
draw(RootGetObject("../example.root", "hist"), "vl,ec", blue);
...
NewPad();
draw(RootGetObject("../example.root", "hist"), "n", red);
...
TH1_x_min = -1;
TH1_x_max = +1;
draw(RootGetObject("../example.root", "hist"), "vl", magenta);
limits((-5, 0), (5, 60));
...
NewPad();
draw(RootGetObject("../example.root", "hist"), "vl,lE,lM,lR", heavygreen);
AttachLegend();

// or an abbreviation
NewPad();
draw(RootGetObject("../example.root", "hist"), "vl,l", heavygreen);
AttachLegend();
